...
`puts "Hello, world!"` to production-grade, master-level engineering — with
...
| [Level 2 · Intermediate](level-2/index.md) | Idiomatic, testable Ruby | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Web apps, databases, concurrency | 9 topics + 1 project |
...
- Every topic page has runnable code snippets — copy them into a local `.rb`
  file and run with `ruby`, or paste into `irb`.
